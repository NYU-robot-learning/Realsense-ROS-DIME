...
namespace realsense2_camera
{
    ...
    const std::string DEFAULT_INFRA_FRAME_ID           = "camera_infra_frame";
    ...
    const std::string DEFAULT_INFRA_OPTICAL_FRAME_ID   = "camera_infra_optical_frame";
    ...
    const std::string DEFAULT_ALIGNED_DEPTH_TO_INFRA_FRAME_ID  = "camera_aligned_depth_to_infra_frame";
